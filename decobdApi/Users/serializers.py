...
from EmailTemplate.SendEmailAllTypesFuction import send_password_reset_link_email,password_reset_success_email
...
class SendPasswordResetEmailSerializer(serializers.Serializer):
  ...
  def validate(self, attrs):
    ...
    if User.objects.filter(email=email).exists():
      ...
      link = 'http://react1.decorationbd.com/api/user/reset/'+uid+'/'+token
