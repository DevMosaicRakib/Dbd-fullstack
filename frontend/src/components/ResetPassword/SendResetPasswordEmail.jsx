...
const SendResetPasswordEmail = () => {
  ...
  return (
    ...
    <div className='w-full  h-[200px] 300px:mt-[150px] 768px:mt-[100px] 300px:mb-[100px] 768px:mb-0'>
      ...
      <h1 className='font-[400] text-[16px] 768PX:text-[20px] text-[#242424]'>Reset your password</h1>
      <form onSubmit={handleSubmit} id='password-reset-email-form'>
        ...
        border-[1px] border-[rgba(0,0,0,0.5)] outline-none font-normal text-[10px] rounded-[5px]' placeholder='Enter your email...'/>
        ...
        mt-[10px] w-[70px] text-[13px] text-center text-white font-[400] bg-[#32ca00] rounded-sm'>Send</button>
      </form>
      </div>
    </div>
    </div>
