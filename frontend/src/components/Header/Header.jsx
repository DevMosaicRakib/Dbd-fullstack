  ...
  return (
    <>
       ...
       w-full items-center  justify-around"
          >
            <div className="1280px:ml-0">
              <Link to="/">
                <img src={logo} alt="logo" className="h-[60%]  w-[55%] mx-auto object-contain"/>
              </Link>
            </div>
            {/* search box */}
            <div className="relative w-[350px]" ref={searchRef}>
              <input
                ...
                className="h-[30px] w-full px-2 1280px:ml-0 text-[10px] 
            border-[#212121] border-[1px] rounded-md outline-none"
              />
                    ...
                    return(
                      <Link to={`/product/${Product_name}`} >
                        <div className="flex w-full items-center py-3 1350px:hover:bg-[#eaeaea]" key={index} onClick={()=>{setSearchTerm("");setSearchData(null)}}>
                          ...
                          <h1 className="font-[400] text-[#4B4A4A] 1280px:text-[10px]">{i.name}</h1>
                        </div>
                      </Link>
                    )
                  })}
                  ...
                  <div className="flex items-center gap-[10px] cursor-pointer group hover:bg-[rgba(255,255,255,0.2)] p-[5px] rounded-[5px]" onClick={()=>{navigate('/profile')}}>
                   ...
                   <div className=" ">
                    ...
                    onClick={()=>navigate('/login')}>
                      ...
                      /><span className="text-white group-hover:text-black font-[400] capitalize text-[13px]"
                      >login</span>  
        ...
        <div>
           ...
           hidden 1280px:block  w-full bg-[#242424] h-[60px] z-[9]`}>
            <div className={`1280px:w-[96%] mx-auto mt-[7px]
     ...
     border-b-[1px] border-[rgba(0,0,0,0.3)]`}>
              <div className={`1280px:w-11/12 mx-auto 
              relative flex items-center justify-around`}>
              <div className="relative h-[56px] w-[300px] mt-[3px]  hidden 1280px:block bg-white z-10"
            ...
            py-2 bg-[#007bc4] font-sans text-[14px] font-[500] select-none rounded-t-md uppercase text-white"
                >
                  browse categories
                </button>
                <IoIosArrowDown
          ...
          <div className="flex w-[113px] overflow-hidden">
            <div className={`${Styles.normal_flex} `} >
          ...
          {dropDown && (
                <div ref={dropDownRef} className={`absolute top-[60px] left-[69px] ${dropDown?'dropDownshow':'dropDownhide'}`}>
                  <div >
            ...
            <div  className="fixed w-full h-full left-0 top-0 bg-[#0000005f] z-20">
              ...
              h-screen top-0 left-0 z-10 overflow-y-scroll`}>
                <div className="flex justify-end pr-3">
                  <RxCross2 size={30} className="mt-5 text-[#242424]"
                ...
                <div className="my-8 w-[96.01%] m-auto h-[40px] relative shadow-md shadow-[gray] rounded-sm py-1">
                  ...
                  outline-none placeholder:text-[10px] " 
                  value={searchTerm}
                  onChange={handleSearchChange}
                  />
                   <AiOutlineSearch
            ...
            "
              />
                          ...
                          searchData&& searchData.map((i,index)=>{
                            ...
                            return(
                              ...
                              <div className="flex items-center my-1"  onClick={()=>{setOpenMobileSideBar(false);setSearchTerm("");setSearchData(null)}}>
                                ...
                                <h5 className="font-[400] text-[10px] text-[#242424]">{i.name}</h5>
                              </div></Link>
                            )
                          } )
                        }
                ...
                <div className="w-[96%] flex items-center justify-center mx-auto">
                  ...
                  py-2 w-[45%] pl-5 uppercase text-[16px]  font-[400] text-[#242424]`}
                  onClick={()=>{
                    setActiveMenu(1);
                  }}>menu</h4>
                  <h4 className={`${activeMenu===2? "border-b-[3px] border-[#077bc4] bg-[#eee]":""}
                  py-2 w-[55%] pl-5 uppercase text-[16px]  font-[400] text-[#242424]`}
                  onClick={()=>{
                    setActiveMenu(2);
                  }}>categories</h4>
                </div>
                    ...
                    <div className="w-[96%] ml-[15px] flex flex-col justify-center mt-[30px] ">
                      <div className="mb-[20px]">
                       <Link to="/" className="flex gap-[10px] items-center" onClick={()=>setOpenMobileSideBar(false)}>
                        ...
                        <h4 className="text-[13px]  uppercase text-[#242424] font-[400] mt-[6px]">home</h4>
                       </Link>
                      </div>
                      <div className="mb-[20px]">
                       <Link to="/shop" className="flex gap-[10px] items-center" onClick={()=>setOpenMobileSideBar(false)}>
                        <CiShop size={26} className="text-[#242424]"/>
                        <h4 className="text-[13px]  uppercase text-[#242424] font-[400] mt-[6px]">shop</h4>
                       </Link>
                      </div>
                      <div className="mb-[20px]">
                       <Link to="/about" className="flex gap-[10px] items-center" onClick={()=>setOpenMobileSideBar(false)}>
                        ...
                        <h4 className="text-[13px]  uppercase text-[#242424] font-[400] mt-[6px]">about us</h4>
                       </Link>
                      </div>
                      <div className="mb-[26px]">
                       <Link to="/contact" className="flex gap-[10px] items-center" onClick={()=>setOpenMobileSideBar(false)}>
                        <MdContactPhone size={26} className="text-[#242424]"/>
                        <h4 className="text-[13px]  uppercase text-[#242424] font-[400] mt-[6px]">contact us</h4>
                       </Link>
                      </div>
                      {!access_token? (
                        ...
                        <div  className="flex gap-[10px] items-center">
                         ...
                         <h4 className="text-[13px] uppercase text-[#242424] font-[400] mt-[6px]"><span onClick={()=>{
                           navigate('/login');
                           setOpenMobileSideBar(false)
                        ...
                        <div className="mt-[50px] w-[calc(100%-15px)] ">
                          <div className=" w-[50%] mx-auto text-center flex flex-col items-center">
                            ...
                            <p className="text-[13px] text-[#242424] font-[400] mt-[10px]">Hello, {profileData?.username}</p>
                            <Link to='/profile' className="w-[120px] h-[30px] border-[2px] border-[#2fb203] outline-none py-1 
                            text-[13px] text-[#242424] font-[400] mt-[10px]"
