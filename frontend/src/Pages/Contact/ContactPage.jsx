...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL}api/email/contact/`, formData);
  ...
  return (
    ...
    mx-auto bg-[rgb(234,234,234,0.3)] mt-[80px] 1280px:mt-[20px] p-[20px]">
      <h1 className="heading uppercase text-[16px] 768px:text-[20px] font-[400] w-[100%] 
      ...
      <div className="768px:w-[40%] w-full mx-auto 768px:mx-0 ">
        <p className="text-[10px] 768px:text-[12px] !font-normal text-[rgb(36,36,36,0.9)] w-[98%] 
        768px:w-[100%]  mb-[10px]">
      ...
      shadow-sm shadow-[transparent] p-5">
        <form onSubmit={handleSubmit}>
          ...
          <label className="text-[13px] font-normal block mb-[5px] text-[rgb(36,36,36,0.9)]">Name:</label>
           <input type="text" className="px-[10px] py-[5px] font-normal
           text-[10px] w-[90%] border-[1px] boreder-[gray] outline-0"
           name="name"
           value={formData.name}
          ...
          <div className="mb-[10px]">
          <label className="text-[13px] font-normal block mb-[5px] text-[rgb(36,36,36,0.9)]">Email:</label>
           <input type="email" className="px-[10px] py-[5px] font-normal
           text-[10px] w-[90%] border-[1px] boreder-[gray] outline-0"
           name="email" 
          ...
          <div className="mb-[10px]">
          <label className="text-[13px] font-normal block mb-[5px] text-[rgb(36,36,36,0.9)]">Message:</label>
           <textarea cols="20" rows="5" className="px-[10px] py-[5px] font-normal
           text-[10px] w-[90%] border-[1px] boreder-[gray] outline-0" 
           name="message"
          ...
          <button type="submit" className="text-[13px] capitalize
           font-[400] outline-none border-[1px] border-[rgb(128,128,128,0.6)] p-[5px] bg-[rgb(203,204,204,0.5)]">send message</button>
        </form>
      </div>
