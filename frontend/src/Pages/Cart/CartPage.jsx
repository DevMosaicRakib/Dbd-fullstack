                ...
                <tr className='w-full border-b border-[rgba(0,0,0,0.2)]'>
                  <td className='flex items-center 768px:py-3 py-1'>
                   ...
                   onChange={() => handleCheckboxChange(item.id, item.sub_total)}/>
                    <img src={item?.products?.product_imgs[0]?.images} alt="" className='w-[50px] h-[50px] object-cover'/>
                    <h4 className='font-normal text-[10px]
                     text-[#242424] 768px:px-[6px] px-[1px]'
                     >
                      {item?.products?.name.length>50?item?.products?.name.slice(0,50)+"...":item?.products?.name}
                      </h4>
                  </td>
                  ...
                  font-normal text-[13px] text-[#242424] py-3'>{Number(item?.products?.discount_price).toFixed(2)} <strong className='text-[13px] font-Roboto'>৳ </strong></td>
                ...
                <div className="w-[68%]">
                  <div className="flex flex-col gap-[5px] justify-center pr-[3px]">
                    <div className="flex  justify-between border-b border-[rgba(0,0,0,0.2)] py-[2px]">
                      <h5 className='w-[90%] text-[13px] text-[#242424] font-[400] capitalize px-[2px]'>{item?.products?.name}</h5>
                    ...
                    <div className="flex items-center justify-between border-b border-[rgba(0,0,0,0.2)] py-[2px]">
                      ...
                      <p className='font-[400] text-[13px] text-[#242424] pr-[3px]'>{Number(item?.products?.discount_price).toFixed(2)} <strong className='text-[13px] font-Roboto'>৳</strong></p> 
                    </div>
                    <div className="flex items-center justify-between border-b border-[rgba(0,0,0,0.2)] py-[2px]">
                    ...
                    <div className="flex items-center justify-between ">
                      ...
                      {Number(item?.sub_total).toFixed(2)} <strong className='text-[13px] font-Roboto'>৳</strong></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full 768px:p-3 1350px:p-1 p-1 sticky top-0">
         ...
         <div className="flex items-center justify-between 768px:px-3 px-1">
           ...
           {checkedItems != null?(
             ...
             '>{Number(totalSum).toFixed(2)}<strong className='text-[13px] font-Roboto'>৳</strong></span>
           ):(
            <span className='text-[13px] font-[400] text-[#077bc4]
            '>0.00<strong className='text-[13px] font-Roboto'>৳</strong></span>
           )}
          </div>
          <div className="flex items-center justify-between 768px:px-3 px-1 py-[4px]">
            ...
            {!allUnchecked?(
                          ...
                          '>150.00<strong className='text-[13px] font-Roboto'>৳</strong></span>
            ):(
              <span className='text-[13px] font-normal text-[#077bc4]
              '>0.00<strong className='text-[13px] font-Roboto'>৳</strong></span>
            )}
            ...
            <h3 className='capitalize text-[13px] font-normal text-[#242424]'>Total :</h3>
              {
                !allUnchecked?(
                  <span className='text-[13px] font-normal text-[#077bc4]
                  '>{(Number(totalSum)+150.00).toFixed(2)}<strong className='text-[13px] font-Roboto'>৳</strong></span>
                ):(
                  <span className='text-[13px] font-[400] text-[#077bc4]
                  '>0.00<strong className='text-[13px] font-Roboto'>৳</strong></span>
                )
